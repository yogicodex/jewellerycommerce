...
<header
    ...
    <div class="flex items-center gap-1.5">
        ...
        <a href="{{ route('admin.dashboard.index') }}">
            ...
            @else
                <img src="{{ request()->cookie('dark_mode') ? bagisto_asset('src/Resources/assets/images/dark-logo.svg') : bagisto_asset('src/Resources/assets/images/logo.svg') }}"
    ...
    <div class="flex items-center gap-2.5">
        ...
        <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            <x-slot:toggle>
                @if ($admin->image)
                    <button
                        class="flex overflow-hidden rounded-full cursor-pointer h-9 w-9 hover:opacity-80 focus:opacity-80">
                        <img src="{{ $admin->image_url }}" class="w-full h-full" />
                    </button>
                @else
                    <button
                ...
                <x-slot:content class="!p-0">
                    ...
                    <div class="grid gap-1 pb-2.5">
                        <a class="px-5 py-2 text-base text-gray-800 cursor-pointer hover:bg-gray-100 dark:text-white dark:hover:bg-gray-950"
...
<script type="text/x-template" id="v-mega-search-template">
        <div class="relative flex w-[525px] max-w-[525px] items-center max-lg:w-[400px] ltr:ml-2.5 rtl:mr-2.5">
            ...
            >
                <!-- Search Tabs -->
                <div class="flex text-sm text-gray-600 border-b dark:border-gray-800 dark:text-gray-300">
                    <div
                        class="p-4 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-950"
                    ...
                    <template v-else>
                                ...
                                <div class="flex gap-2.5">
                                    ...
                                    >
                                        <template v-if="! product.images.length">
                                            <img src="{{ bagisto_asset('src/Resources/assets/images/product-placeholders/front.svg') }}">
                        ...
                        <div class="flex p-3 border-t dark:border-gray-800">
                            <a
                                ...
                                class="text-xs font-semibold text-blue-600 transition-all cursor-pointer hover:underline"
                    ...
                    <template v-else>
                        <div class="grid max-h-[400px] overflow-y-auto">
                            <a
                                ...
                                class="p-4 text-sm font-semibold text-gray-600 border-b cursor-pointer last:border-b-0 hover:bg-gray-100 dark:border-gray-800 dark:text-gray-300 dark:hover:bg-gray-950"
...
<script type="text/x-template" id="v-notifications-template">
        <x-admin::dropdown position="bottom-{{ core()->getCurrentLocale()->direction === 'ltr' ? 'right' : 'left' }}">
            ...
            <x-slot:content class="min-w-[250px] max-w-[250px] !p-0">
                <!-- Header -->
                <div class="p-3 text-base font-semibold text-gray-600 border-b dark:border-gray-800 dark:text-gray-300">
    ...
    app.component('v-dark', {
        ...
        data() {
            return {
                ...
                logo: "{{ bagisto_asset('src/Resources/assets/images/logo.svg') }}",

                dark_logo: "{{ bagisto_asset('src/Resources/assets/images/dark-logo.svg') }}",
            };
        },
