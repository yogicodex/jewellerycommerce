...
<head>
    ...
    @else
        <link type="image/x-icon" href="{{ bagisto_asset('src/Resources/assets/images/favicon.ico') }}" rel="shortcut icon"
            sizes="16x16" />
    @endif
...
<body class="h-full dark:bg-gray-950">
    ...
    <div id="app" class="h-full">
        ...
        <div class="group/container {{ request()->cookie('sidebar_collapsed') ?? 0 ? 'sidebar-collapsed' : 'sidebar-not-collapsed' }} flex gap-4"
            ...
            <div
                class="flex min-h-[calc(100vh-62px)] max-w-full flex-1 flex-col bg-white pt-3 transition-all duration-300 dark:bg-gray-950 ltr:pl-[270px] group-[.sidebar-collapsed]/container:ltr:pl-[69px] rtl:pr-[270px] group-[.sidebar-collapsed]/container:rtl:pr-[69px]">
                ...
                <div class="mt-auto">
                    <div
                        class="py-2 text-sm text-center bg-white border-t dark:border-gray-800 dark:bg-gray-900 dark:text-white">
