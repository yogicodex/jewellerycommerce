...
<div class="flex gap-4">
    ...
    <x-admin::modal class="[&>*>*>.box-shadow]:!max-w-[1000px]">
        ...
        <x-slot:content class="!border-none">
            <img
                ...
                src="{{ bagisto_asset('src/Resources/assets/images/configuration/default-menu.svg') }}"
    ...
    <x-admin::modal class="[&>*>*>.box-shadow]:!max-w-[1000px]">
        ...
        <x-slot:content class="!border-none">
            <img 
                class="border border-gray-200"
                src="{{ bagisto_asset('src/Resources/assets/images/configuration/side-bar-menu.svg') }}"
