    ...
    >
        <div class="box-shadow rounded bg-white dark:bg-gray-900">
                            ...
                            >
                                <template v-if="! item.product.images.length">
                                    <img
                                        ...
                                        src="{{ bagisto_asset('src/Resources/assets/images/product-placeholders/front.svg') }}"
                                    >
            ...
            <div
                ...
                v-else
            >
                <img src="{{ bagisto_asset('src/Resources/assets/images/icon-add-product.svg') }}" class="h-20 w-20 dark:mix-blend-exclusion dark:invert">
            ...
            >
                ...
                <x-slot:content class="!p-0">
                    ...
                    >
                        <!-- Placeholder Image -->
                        <img
                            src="{{ bagisto_asset('src/Resources/assets/images/icon-add-product.svg') }}"
