                            ...
                            <div class="relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                ...
                                @if (core()->getConfigData('sales.checkout.shopping_cart.cart_page'))
                                    ...
                                    @endif
                                       ...
                                       @php
                                        // Your business WhatsApp number (use international format without '+' or '00')
                                        $whatsappNumber = '919876543210'; 
                                        $message = urlencode("Hello! I'm interested in the product: " . $product->name . " (" . route('shop.product_or_category.index', $product->url_key) . ")");
                                    ...
                                    <a href="{{ $whatsappUrl }}" target="_blank" rel="noopener noreferrer">
                                        <x-shop::button
                                            type="button"
                                            class="primary-button mt-5 w-full max-w-[470px] max-md:py-3 max-sm:mt-3 max-sm:rounded-lg max-sm:py-1.5 bg-green-500 hover:bg-green-600 uppercase"
                                            button-type="primary-button"
