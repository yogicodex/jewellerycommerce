...
<x-shop::layouts :has-feature="false">
    ...
    <div class="flex items-center justify-center px-6 mt-8 max-md:mt-5">
    ...
    @pushOnce('scripts')
        ...
        >
        <div class="items-center justify-between hidden p-4 mt-10 border sm:flex">
            <div>
                    ...
                    <div class="flex-1">
                        ...
                        <div v-else>
                            ...
                            <template v-if="isLoading">
                                <div class="grid grid-cols-4 gap-8 mt-8 max-1060:grid-cols-2 max-md:gap-x-4 max-sm:mt-5 max-sm:justify-items-center max-sm:gap-y-5">
                            ...
                            <template v-else>
                                <template v-if="products.length">
                                    <div class="grid grid-cols-4 gap-8 mt-8 max-1060:grid-cols-2 max-md:mt-5 max-md:justify-items-center max-md:gap-x-4 max-md:gap-y-5">
                                        <!-- 
                                            THE FIX IS HERE:
