                                ...
                                >
                                    ...
                                    <div class="flex gap-5 rounded-xl border border-zinc-200 p-6 max-md:hidden max-md:gap-1.5">
                                        ...
                                        <x-shop::media.images.lazy
                                            ...
                                            src="{{ $review->product->base_image_url ?? bagisto_asset('src/Resources/assets/images/small-product-placeholder.webp') }}"
                                            alt="Review Image"                   
                                        />
                    ...
                    @else
                        ...
                        <div class="m-auto grid w-full place-content-center items-center justify-items-center py-32 text-center">
                            <img
                                ...
                                src="{{ bagisto_asset('src/Resources/assets/images/review.png') }}"
                                alt="Empty Review"
                                title=""
                            >
