        ...
        <div>
            ...
            <div class="flex justify-between max-md:hidden">
                ...
                >
                    <x-slot:toggle>
                        <!-- Dropdown Toggler -->
                        <button class="flex w-full items-center justify-center gap-x-1 rounded-lg  px-3 py-1.5 text-xs transition-all hover:bg-gray-100 uppercase">
                            @{{ sortLabel ?? "@lang('shop::app.products.sort-by.title')" }}

                            <span
                                class="icon-arrow-down text-sm"
                                role="presentation"
                            ></span>
                        </button>
                    </x-slot>
                    ...
                    <x-slot:menu class="-left-2">
                        ...
                        >
                            <span class="text-xs">@{{ sort.title }}</span>
                        </x-shop::dropdown.menu.item>
                    </x-slot>
                </x-shop::dropdown>
